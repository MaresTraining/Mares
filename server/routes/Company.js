...
import { signinCompany, signupCompany , testCompany ,resetPassword,updateProfileCV ,deleteAccount,ViewProfile,ViewStudentPage,AddOpportunities,SelectStudents } from '../controllers/company.js';

router.post('/sign-in',signinCompany );
router.post('/sign-up', signupCompany);
router.get('/testCompany', testCompany);
router.post("/reset-password", resetPassword);
router.post('/update-profile-cv', updateProfileCV);//CreateProfile/updateProfile
